<?php
    ...
    $opt_name = apply_filters( 'ocws_qhlt/opt_name', $opt_name );
    ...
    $args = array(
        ...
        'display_name'         => $theme->get( 'Qohelet Theme Options' ),
        // Name that appears at the top of your panel
        'display_version'      => $theme->get( '0.2' ),
        // Version that appears at the top of your panel
        'menu_type'            => 'submenu',
        //Specify if the admin menu should appear or not. Options: menu or submenu (Under appearance only)
        'allow_sub_menu'       => true,
        // Show the sections below the admin menu item or not
        'menu_title'           => __( 'Qohelet Options', 'redux-framework-demo' ),
        'page_title'           => __( 'Qohelet Options', 'redux-framework-demo' ),
    ...
    if ( ! isset( $args['global_variable'] ) || $args['global_variable'] !== false ) {
        ...
        $args['intro_text'] = __( '<p>Qohelet is a fully responsive theme for Wordpress. It has been built on the shoulders of giants, utilizing a number of other technologies, such as:</p> <ol><li>The Quark starter theme by Anthony Horton.</li><li>Quark is in turn built upon Underscores by Automattix.</li><li>Quark utilizes Normalize, Modernizr and Options Framework.</li><li>I have replaced Options Framework with the Redux Framework.</li><li>Qohelet also features a slider, based on Flexislide.</li><li>Many other smaller amounts of other technologies have been incorporated, so that I did not re-invent the wheel.</li></ol>', 'redux-framework-demo' );
    }

    // Add content after the form.
    $args['footer_text'] = __( '<p>This theme has been designed and programmed by <a href=\"http://www.oldcastleweb.com\">Old Castle Web Services</a>.</p>', 'redux-framework-demo' );
